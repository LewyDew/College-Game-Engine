...
Level01Room::Level01Room()
{
	...
	SFMLWall * Wall6 = InstanceCreate(new SFMLWall("Wall", 360, 60));
	Wall6->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall7 = InstanceCreate(new SFMLWall("Wall", 420, 60));
	Wall7->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall8 = InstanceCreate(new SFMLWall("Wall", 480, 60));
	Wall8->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall9 = InstanceCreate(new SFMLWall("Wall", 540, 60));
	Wall9->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall10 = InstanceCreate(new SFMLWall("Wall", 60, 120));
	Wall10->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall11 = InstanceCreate(new SFMLWall("Wall", 540, 120));
	Wall11->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall12 = InstanceCreate(new SFMLWall("Wall", 60, 180));
	Wall12->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall13 = InstanceCreate(new SFMLWall("Wall", 540, 180));
	Wall13->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall14 = InstanceCreate(new SFMLWall("Wall", 60, 240));
	Wall14->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall15 = InstanceCreate(new SFMLWall("Wall", 540, 240));
	Wall15->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall16 = InstanceCreate(new SFMLWall("Wall", 480, 240));
	Wall16->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall17 = InstanceCreate(new SFMLWall("Wall", 60, 300));
	Wall17->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall18 = InstanceCreate(new SFMLWall("Wall", 480, 300));
	Wall18->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall19 = InstanceCreate(new SFMLWall("Wall", 60, 360));
	Wall19->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall20 = InstanceCreate(new SFMLWall("Wall", 480, 360));
	Wall20->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall24 = InstanceCreate(new SFMLWall("Wall", 120, 360));
	Wall24->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall21 = InstanceCreate(new SFMLWall("Wall", 180, 360));
	Wall21->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall22 = InstanceCreate(new SFMLWall("Wall", 240, 360));
	...
	SFMLWall * Wall41 = InstanceCreate(new SFMLWall("Wall", 240, 240));
	Wall41->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLWall * Wall42 = InstanceCreate(new SFMLWall("Wall", 360, 240));
	Wall42->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLBox * Box1 = InstanceCreate(new SFMLBox("Box", 180, 180));
	Box1->SetSpriteOffset(sf::Vector2f(30, 30));

	SFMLBox * Box2 = InstanceCreate(new SFMLBox("Box", 300, 180));
	...
	goal * Goal1 = InstanceCreate(new goal("Goal", 180, 420));
	Goal1->SetSpriteOffset(sf::Vector2f(30, 30));
	goal * Goal2 = InstanceCreate(new goal("Goal", 180, 480));
	Goal2->SetSpriteOffset(sf::Vector2f(30, 30));
	goal * Goal3 = InstanceCreate(new goal("Goal", 240, 480));
	...
	Guy->SetImageSpeed(0);
	GoalChecker * checker = InstanceCreate(new GoalChecker("Wall", -10000, 10000, 1, 1, 1));
